...
In this project we aimed to explore methods of learning differences between healthy and AA HSPCs using the scRNA-seq data published by \citet{tonglin_single-cell_2022}.
We aimed to develop models of both healthy and diseased HSPC transcriptome profiles to identify perturbations capable of moving a diseased HSPC to a healthy cell or vice versa.
Our current proposed approach is based on machine learning methods we have learned in previous coursework. We may adjust our methods as we learn more about transcriptomics analysis in upcoming lectures.
